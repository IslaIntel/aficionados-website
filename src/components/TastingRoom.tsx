...
export function TastingRoom() {
  ...
  return (
    <section id="tasting" className="bg-ivory px-6 py-24 lg:px-10 lg:py-32">
        ...
        <SectionReveal>
          <div className="relative overflow-hidden">
            <Image
              ...
              priority
            />
            <div className="absolute inset-0 bg-gradient-to-tr from-charcoal/35 via-transparent to-transparent" />
          </div>
        </SectionReveal>
